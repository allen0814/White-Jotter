package com.gm.lyl.config;

import com.gm.lyl.filter.URLPathMatchingFilter;
import com.gm.lyl.realm.LylRealm;
...
public class ShiroConfiguration {
    ...
    public SecurityManager securityManager() {
        ...
        securityManager.setRealm(getLylRealm());
    ...
    @Bean
    public LylRealm getLylRealm() {
        LylRealm lylRealm = new LylRealm();
        lylRealm.setCredentialsMatcher(hashedCredentialsMatcher());
        return lylRealm;
    }
